          ...
          >
            ...
            <div className="flex items-center justify-between px-5 py-3 border-b-4 border-black bg-black text-white shrink-0">
              ...
              <div className="flex items-center gap-2">
                ...
                {/* Download */}
                <a
                  href={getGoogleDriveDownloadUrl(resumeUrl)}
                  download={downloadName}
                  target={resumeUrl.includes('drive.google.com') ? '_blank' : undefined}
                  rel={resumeUrl.includes('drive.google.com') ? 'noopener noreferrer' : undefined}
                  onClick={playClick}
            ...
            <div className="relative flex-1 min-h-0 bg-zinc-100">
              ...
              {hasError ? (
                ...
                <iframe
                  ref={iframeRef}
                  src={getGoogleDrivePreviewUrl(resumeUrl)}
